...
public class loginView extends javax.swing.JFrame {
    ...
    loginView(String oeo, String admin) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 160, 20));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/event-planningand-management-1024x683-750x350.jpg"))); // NOI18N
        jLabel3.setText("jLabel3");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 0, 690, 340));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
if (jTextField1.getText().equals("oeo")&& jPasswordField1.getText().equals("admin"))
        {
            setVisible(false);
            new homeController().setVisible(true);
        }
        else{
             JOptionPane.showMessageDialog(null,"Incorrect Username or Password","Select",JOptionPane.YES_NO_OPTION);
